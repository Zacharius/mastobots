...
class Logger:
    ...
    def __logLinkedToot(self, text, author):
        ...
        self.__insertAfterString(self.readSection, linkedTootString)

    def __logLocalToot(self, text, author):
        localTootString = formatLocalTootLog(text, author)
        self.__insertAfterString(self.opinionSection, localTootString)
    ...
    def __insertAfterString(self, seekString, insertString):
        ...
        logText = logText.replace(seekString,
                                  seekString + '\n' + insertString, 1)
